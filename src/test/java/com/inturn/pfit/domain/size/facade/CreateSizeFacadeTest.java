...
class CreateSizeFacadeTest {
	...
	void createSize_Fail_DuplicateSizeTypeOrderList() {
		...
		//when & then
		final DuplicateSizeTypeOrderException result =  assertThrows(DuplicateSizeTypeOrderException.class, () -> createSizeFacade.createSize(createSizeRequestDTO));
